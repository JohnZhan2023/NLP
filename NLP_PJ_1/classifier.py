...
from encoder import RNNEncoder, Transformer
...
class classifier(nn.Module):
    ...
    # those three functions are designed for the pytorch lightning but due to the torchtext's version conflicts, I directly use my trainer
...
if __name__ == '__main__':
    ...
    wrapper = classifier(input_size=100, hidden_size=256, num_layers=2, num_class=5, dropout=0.1, attention=False, encoder='rnn', embedding_type='train', TEXT=TEXT)
